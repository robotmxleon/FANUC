...
COMMENT     = ""
PROG_SIZE   = 913;
CREATE      = DATE 23-04-22  TIME 19:45:13;
MODIFIED      = DATE 23-04-22  TIME 19:45:13;
FILE_NAME   = ;
VERSION    = 0;
LINE_COUNT  = 13;
MEMORY_SIZE = 1197;
...
5:! Pickup ('Parte Soldadura') From ('Conveyorn Entrada:Link1') With ('GP: 1 - UT: 1  (TCP_Gripper)') ;
7:!WAIT 0.00 (sec) ;
/POS
/END
